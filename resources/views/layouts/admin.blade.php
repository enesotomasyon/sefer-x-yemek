...
<head>
    ...
    <title>@yield('title', 'Admin Paneli') - Dijital Menü</title>
        ...
        <aside class="w-72 flex-shrink-0" style="background-color: var(--sidebar-bg); border-right: 1px solid rgba(0,0,0,0.06);">
            <div class="p-6 border-b" style="border-color: rgba(0,0,0,0.06);">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg font-bold text-gray-900">Admin Paneli</h1>
            ...
            <nav class="mt-2 px-3">
                <a href="{{ route('admin.dashboard') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-chart-line w-5"></i>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('admin.owners.index') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.owners.*') ? 'active' : '' }}">
                    <i class="fas fa-users w-5"></i>
                    <span>İşletme Sahipleri</span>
                </a>
                <a href="{{ route('admin.restaurants.index') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.restaurants.*') ? 'active' : '' }}">
                    <i class="fas fa-store w-5"></i>
                    <span>Restoranlar</span>
                </a>
                <a href="{{ route('admin.categories.index') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                    <i class="fas fa-tags w-5"></i>
                    <span>Kategoriler</span>
                </a>
                <a href="{{ route('admin.sliders.index') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.sliders.*') ? 'active' : '' }}">
                    <i class="fas fa-images w-5"></i>
                    <span>Slider Yönetimi</span>
                </a>
                <a href="{{ route('admin.settings.index') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
                    <i class="fas fa-cog w-5"></i>
                    <span>Site Ayarları</span>
                </a>
                <a href="{{ route('admin.branches.index') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg mb-1 border-l-4 border-transparent {{ request()->routeIs('admin.branches.*') ? 'active' : '' }}">
                    <i class="fas fa-code-branch w-5"></i>
                    <span>Şube Onayları</span>
                </a>
            </nav>
